 ...
 <!-- Main Container Start -->
        <div id="mws-container" class="clearfix">
          ...
          <div class="mws-panel-body no-padding">
               <form action="goods.php?m=home&c=index&a=doadd" method="post" class="mws-form" enctype="multipart/form-data">
                         ...
                         <div class="mws-form-row">
                          ...
                          <div class="mws-form-inline">
                           ...
                           <div class="mws-form-row">
                            ...
                            <div class="mws-form-item">
                             <script id="editor" type="text/plain"  name="descr" style="width:550px;height:300px;"></script>
