  ...
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
     <form action="/tp/Admin.php?m=home&c=index&a=index" method="post">
        ...
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 55px;" aria-label="CSS grade: activate to sort column ascending">操作</th>
         ...
         <tbody role="alert" aria-live="polite" aria-relevant="all">
           <?php if(is_array($info)): foreach($info as $key=>$row): ?><tr class="odd">
                    ...
                    <td class=" "><a href="/tp/Admin.php?m=home&c=index&a=delete&id=<?php echo ($row['id']); ?>"><i class="icon-trash"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/tp/Admin.php?m=home&c=index&a=edit&id=<?php echo ($row['id']); ?>"><i class="icon-wrench"></i></a></li></td>
