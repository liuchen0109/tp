...
<body>
  ...
  <div class="mws-panel grid_8">
          ...
          <div class="mws-panel-body no-padding">
               <form action="/tp/admin.php?m=home&c=index&a=doAdd" method="post" class="mws-form">
                    ...
                    <div class="mws-form-inline">
                         ...
                         <div class="mws-form-row">
                              ...
                              <div class="mws-form-item">
                                   <input value="" type="password" name="password" class="small">
                              </div>
                         </div>
                ...
                <div class="mws-form-row">
                              ...
                              <div class="mws-form-item">
                                   <input value="" type="password" name="repassword" class="small">
                              </div>
